...
PointClickEngine.RegisterGame({
    id: 'testgame', title: 'Test Game: The Locked Door', author: 'James E. Petts', titleBackground: 'rooms/intro_testgame_recursive_90s_v1.png', titleMusic: ['music/intro.mp3'], endBackground: 'rooms/end_screen_v1.png', endMusic: ['music/outtro.mp3'], engineApi: 1, startRoomId: 'testRoom',
    ...
    sprites: { player: { image: 'characters/player_animations_v1.png', frameW: 16, frameH: 32, frames: 4, rows: 8, directional: true, animations: { idle: { rowOffset: 0, frames: 1, fps: 1 }, walk: { rowOffset: 0, frames: 4, fps: 12 }, talk: { rowOffset: 4, frames: 4, fps: 6 } } }, caretaker: { image: 'characters/npc_animations_cartoon90s_v2.png', frameW: 16, frameH: 32, frames: 2, rows: 8, directional: true, walkFps: 4, idleFps: 1, animations: { idle: { rowOffset: 0, frames: 1, fps: 1 }, walk: { rowOffset: 0, frames: 2, fps: 4 }, talk: { rowOffset: 4, frames: 2, fps: 6 } } }, woofer: { image: 'characters/woofer_animations_cartoon90s_v2.png', frameW: 24, frameH: 16, frames: 2, rows: 8, directional: true, walkFps: 5, idleFps: 1, animations: { idle: { rowOffset: 0, frames: 1, fps: 1 }, walk: { rowOffset: 0, frames: 2, fps: 5 }, tailWag: { rowOffset: 4, frames: 2, fps: 8 } } } },
    ...
    rooms: {
        testRoom: {
            id: 'testRoom', name: 'Starting Room', background: 'rooms/testroom_start_room_object_door_v1.png', walkableArea: { x: 8, y: 86, w: 304, h: 48 }, music: ['music/main_room.mp3'],
            walkGraph: {
                nodes: [
            ...
            hotspots: [
                { id: 'door', name: 'door', rect: { x: 250, y: 31, w: 45, h: 56 }, x: 248, y: 30, sprite: 'objects/door_opening_animation_v1.png', frameW: 48, frameH: 58, animation: 'closed', animations: { closed: { frame: 0, frames: 1 }, open: { frames: 4, fps: 5, loop: false } }, animationCompleteScripts: { open: 'doorOpenAnimationComplete' }, walkTo: { x: 270, y: 114 }, defaultText: 'It is a sturdy wooden door.', interactions: { lookAt: 'lookDoor', open: 'openDoor', 'use:key': 'unlockDoor' } }
            ],
            characters: [
                { id: 'caretaker', name: 'caretaker', spriteId: 'caretaker', x: 190, y: 116, facing: 'down', rect: { x: 182, y: 84, w: 16, h: 32 }, hitW: 16, hitH: 32, walkTo: { x: 174, y: 116 }, defaultText: 'The caretaker waits patiently.', refusals: { open: "I'm not qualified to perform surgery" }, interactions: { lookAt: 'lookCaretaker', talkTo: 'talkCaretaker', give: 'giveCoinToCaretaker', 'give:coin': 'giveCoinToCaretaker' } },
        ...
        storeRoom: {
            id: 'storeRoom', name: 'Store Room', background: 'rooms/testroom_left_v1.png', walkableArea: { x: 8, y: 86, w: 304, h: 48 }, music: ['music/main_room.mp3'],
            walkGraph: {
                nodes: [
    ...
    scripts: {
        ...
        doorOpenAnimationComplete: function (api) { api.SetFlag('doorOpening', false); api.SetFlag('doorOpen', true); api.SetObjectState('door', { hitDisabled: true }); },
        ...
        lookTable: function (api) { api.Narrate('A plain wooden table. Somewhere on it, allegedly, is a coin. This is what historians call interface design.'); },
