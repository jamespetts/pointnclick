...
PointClickEngine.RegisterGame({
    ...
    scripts: {  
        ...
        completeTestGame: function (api) { api.EndGame('Test Complete', 'You have completed the test game, negotiated its tiny economy, opened the locked door, and walked through it. Somewhere, a test harness nods approvingly.'); return api.MakeActionResult('ended', { action:'transition', reason:'testGameComplete', continueCutscene:false }); },
        endThroughDoor: function (api) { return api.RunScript('completeTestGame'); },
